...
- The pyramid is rotating about the x-axis with given constant speed
...
function render() {
    ...
    let camY = cameraCircleHeight * (1 + Math.sin(glMatrix.toRadian(cameraCircleSpeed / 2 * elapsedTime)));
